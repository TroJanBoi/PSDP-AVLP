                ...
                <div key={platform.name} className="flex items-center">
                  <div className="w-full">
                    ...
                    <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-2">
                      ...
                      <button
                        className={`flex items-center w-full md:w-36 justify-center text-white text-sm ${platform.status === 'Connect'
                            ? 'bg-[#a593f5]'
                            : 'bg-[#979594]'
                ...
                <div className="space-y-2">
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`flex items-center w-full p-2 md:p-3 rounded-md text-sm ${activeTab === tab.name
                          ? 'bg-white text-black'
