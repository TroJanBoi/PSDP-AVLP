        ...
        <div className="flex justify-center items-center h-screen w-screen bg-primary relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col justify-center items-center bg-background 
                ...
                <div className="flex flex-col gap-3 justify-center items-center w-full sm:w-3/4 md:w-3/4 lg:w-3/4 mt-4">
                    ...
                    {/* Social Login Options - Significantly reduced space */}
                    <div className="flex flex-col justify-center items-center w-4/5 sm:w-3/4 md:w-3/4 lg:w-3/4 gap-2">
                        {/* Removed margin-top completely and reduced gap from gap-3 to gap-2 */}
                        {/* Line 2 - Reduced margin */}
                        <div className="w-full px-4">
                            <div className="w-full border-b-2 border-primary mb-1"></div>
                            {/* Reduced mb-2 to mb-1 */}
                        </div>
                        
                        {/* Container to match the padding of the form container */}
                        <div className="w-full px-4">
                            {/* Google Login */}
                            <button className={buttonClass + " mb-2"}>
